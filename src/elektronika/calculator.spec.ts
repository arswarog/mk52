...
import { RegisterName } from './core/registers';
    ...
    describe('Keyboard controller', () => {
        ...
        describe('Commands with register', () => {
            it('XtR 1', () => {
                ...
                expect(calc.registers.get(RegisterName.R1).toString()).toBe(' 0.          ');
                ...
                expect(calc2.registers.get(RegisterName.R1).toString()).toBe(displayX);
                expect(calc2.stat.executed).toBe(1);

                const expected = calc.clone({
                    registers: calc.registers.set(RegisterName.R1, calc.stack.x),
                    stat: {
                        ...calc.stat,
                        executed: 1,
                    },
